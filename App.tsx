      ...
      >
        <div className="space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { icon: <Cpu className="text-blue-500" />, title: "AI Gemini 3.0", desc: "Sử dụng mô hình ngôn ngữ lớn nhất để nhận diện văn bản chính xác." },
              { icon: <FileSpreadsheet className="text-emerald-500" />, title: "Xuất Excel chuẩn", desc: "Dữ liệu được định dạng sẵn sàng cho các phần mềm lưu trữ." },
              { icon: <Monitor className="text-violet-500" />, title: "Giao diện hiện đại", desc: "Trải nghiệm người dùng mượt mà với hiệu ứng motion cao cấp." }
            ].map((feature, i) => (
              <motion.div 
                key={i}
                initial={{ opacity: 0, y: 20 }}
